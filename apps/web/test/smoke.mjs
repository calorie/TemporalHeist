...
try {
  ...
  const result = await page.evaluate(() => ({ info: window.th.rendererInfo(), errors: window.th.errors(), canvas: { width: document.querySelector('canvas').width, height: document.querySelector('canvas').height } }));
